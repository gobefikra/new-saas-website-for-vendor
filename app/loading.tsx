  ...
  return (
    <div className="min-h-[70vh] bg-white px-6 pt-10 md:px-10 md:pt-14" aria-busy="true" aria-live="polite">
      <div className="mx-auto max-w-5xl animate-pulse">
        <div className="h-3 w-24 rounded-full bg-brand-green-light" />
        <div className="mt-5 h-10 max-w-xl rounded-2xl bg-gray-100 md:h-12" />
        <div className="mt-4 h-4 max-w-lg rounded-full bg-gray-100" />
        <div className="mt-3 h-4 max-w-md rounded-full bg-off-white" />

        <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          <div className="h-44 rounded-2xl bg-off-white ring-1 ring-gray-100" />
          <div className="h-44 rounded-2xl bg-off-white ring-1 ring-gray-100" />
          <div className="hidden h-44 rounded-2xl bg-off-white ring-1 ring-gray-100 lg:block" />
        </div>
      </div>
    </div>
  );
