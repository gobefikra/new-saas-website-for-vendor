          ...
          >
            ...
            >
              <div className="flex h-[560px] flex-col lg:h-[580px] lg:flex-row">
                {/* Sidebar — compact horizontal strip on mobile, full rail on desktop */}
                <aside
                  className="flex w-full shrink-0 flex-col border-b border-emerald-950/40 lg:w-[188px] lg:justify-between lg:border-b-0 lg:border-r"
                  style={{ backgroundColor: SIDEBAR_BG }}
                >
                  <div className="flex items-center justify-between gap-3 px-3 pt-2.5 pb-2 lg:mb-0 lg:block lg:p-3">
                    <div className="w-fit shrink-0 rounded-lg bg-white px-2.5 py-1.5 lg:mb-5 lg:w-full lg:py-2">
                      <Image
                    ...
                    <div className="shrink-0 text-right lg:hidden">
                      <p className="truncate text-[11px] font-medium text-white/90">Jaydon</p>
                      <p className="truncate text-[9px] text-white/40">demo</p>
                    </div>
                  </div>

                  {/* Mobile: horizontally scrollable nav chips */}
                  <nav className="dashboard-scroll flex gap-1 overflow-x-auto px-2.5 pb-2.5 lg:hidden">
                    {DASHBOARD_NAV.map((item) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <span className="max-w-[4.5rem] truncate text-[9px] font-medium leading-none">
                            {item.id}
                          </span>
                        </button>
                      );
                  ...
                  <div className="mt-4 hidden border-t border-white/10 px-4 pb-3 pt-3 lg:block">
                ...
                <div className="flex min-h-0 min-w-0 flex-1 flex-col lg:flex-row">
                  <div className="dashboard-scroll min-h-0 min-w-0 flex-1 overflow-y-auto bg-[#F9FAFB] p-3 sm:p-5">
                    {navLoading ? (
