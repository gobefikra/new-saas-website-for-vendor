          ...
          <div className="mx-auto max-w-[1200px]">
            <div className="mb-6 lg:hidden">
              ...
              <select
                ...
                className="w-full appearance-none rounded-xl border border-gray-200 bg-white p-3.5 px-4 text-[15px] font-medium text-gray-900 shadow-sm focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-100"
                style={{
